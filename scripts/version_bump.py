...
class VersionBumper:
    ...
    def update_init_file(self, new_version: str) -> bool:
        ...
        init_files = [self.project_root / "__init__.py", self.project_root / "vertex_flow" / "__init__.py"]
...
示例:
  ...
  %(prog)s patch --dry-run         # 预览版本变更
    ...
    parser.add_argument("action", choices=["show", "patch", "minor", "major"], help="要执行的操作")
