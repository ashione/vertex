...
class TestFunctionTool(unittest.TestCase):
    ...
    def test_function_tool_creation(self):
        ...
        schema = {
            "type": "object",
            "properties": {"input": {"type": "number", "description": "Input number"}},
            "required": ["input"],
        }
    ...
    def test_function_tool_to_dict(self):
        ...
        expected = {
            "type": "function",
            "function": {"name": "test_tool", "description": "A test tool", "parameters": schema},
        }
...
class TestFunctionToolExecutor(unittest.TestCase):
    ...
    def test_execute_function_tool_error(self):
        """测试函数工具执行错误"""
        tool_call = RuntimeToolCall(
            {"id": "call_error", "type": "function", "function": {"name": "error_tool", "arguments": "{}"}}
        )
    ...
    def test_execute_unknown_function_tool(self):
        """测试执行未知函数工具"""
        tool_call = RuntimeToolCall(
            {"id": "call_unknown", "type": "function", "function": {"name": "unknown_tool", "arguments": "{}"}}
        )
...
class TestRegularToolExecutor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tools = [{"type": "function", "function": {"name": "regular_tool", "description": "A regular tool"}}]
    ...
    def test_execute_with_tool_caller(self):
        ...
        tool_call = RuntimeToolCall(
            {"id": "call_123", "type": "function", "function": {"name": "regular_tool", "arguments": "{}"}}
        )
    ...
    def test_execute_without_tool_caller(self):
        ...
        tool_call = RuntimeToolCall(
            {"id": "call_fallback", "type": "function", "function": {"name": "regular_tool", "arguments": "{}"}}
        )
    ...
    def test_execute_tool_caller_error(self):
        ...
        tool_call = RuntimeToolCall(
            {"id": "call_error", "type": "function", "function": {"name": "regular_tool", "arguments": "{}"}}
        )
...
class TestAdvancedToolManager(unittest.TestCase):
    ...
    def test_register_function_tool(self):
        ...
        # 测试执行
        tool_calls = [{"id": "call_custom", "type": "function", "function": {"name": "custom_tool", "arguments": "{}"}}]
    ...
    def test_tool_execution_priority(self):
        ...
        tool_calls = [{"id": "call_mcp", "type": "function", "function": {"name": "mcp_test_tool", "arguments": "{}"}}]
        ...
        tool_calls = [
            {
                "id": "call_function",
                "type": "function",
                "function": {"name": "math_tool", "arguments": '{"a": 2, "b": 3}'},
            },
