...
class WeChatHandler:
    ...
    def create_text_reply(
        self, to_user: str, from_user: str, content: str, timestamp: str = None, nonce: str = None
    ) -> str:
        """创建文本回复消息"""
    ...
    def create_image_reply(
        self, to_user: str, from_user: str, media_id: str, timestamp: str = None, nonce: str = None
    ) -> str:
        """创建图片回复消息"""
        if timestamp is None:
            timestamp = str(int(time.time()))
