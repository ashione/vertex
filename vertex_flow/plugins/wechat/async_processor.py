...
class AsyncMessageProcessor:
    ...
    async def submit_task(self, user_openid: str, message_content: str, 
                         workflow_name: Optional[str] = None,
    ...
    async def _process_task(self, task: AsyncTask):
        ...
        try:
            ...
            if self.wechat_api and response:
                success = await self.wechat_api.send_customer_service_message(
                ...
                if success:
                    ...
                    # 更新用户会话
                    self.message_processor.update_user_session(
                        task.user_openid, 
