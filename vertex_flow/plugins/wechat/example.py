...
async def test_message_processing():
    ...
    # 初始化消息处理器
    processor = MessageProcessor(api_base_url=config.vertex_flow_api_url, default_workflow=config.default_workflow)

    # 测试文本消息处理
    test_messages = ["你好，请介绍一下自己", "今天天气怎么样？", "帮我写一首关于春天的诗", "什么是人工智能？"]
    ...
    for i, message in enumerate(test_messages, 1):
        ...
        try:
            response = await processor.process_message(user_id="test_user_123", content=message)
